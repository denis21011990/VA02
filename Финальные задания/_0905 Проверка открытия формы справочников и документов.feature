...
Функционал: Проверка открытия форм справочников и документов

Как Тестировщик я хочу
открывать формы документов и справочников
чтобы проверить наличие ошибок при открытии

Контекст: 
	И Я запускаю сценарий открытия TestClient или подключаю уже существующий
	
Сценарий: _0905 Проверка открытия формы справочников и документов
